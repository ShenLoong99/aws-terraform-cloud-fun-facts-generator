...
| <a name="input_invoke_arn"></a> [invoke\_arn](#input\_invoke\_arn) | Invoke ARN of lambda function | `string` | n/a | yes |

## Outputs

| Name | Description |
|------|-------------|
| <a name="output_api_endpoint"></a> [api\_endpoint](#output\_api\_endpoint) | Public API endpoint |
